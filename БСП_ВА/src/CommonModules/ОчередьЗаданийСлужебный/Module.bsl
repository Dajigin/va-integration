...
Процедура ОбработатьОчередьЗаданий(КлючФоновогоЗадания, Задание = Неопределено, ИсполняющееФоновоеЗадание = Неопределено) Экспорт
	...
	Пока МожноВыполнять Цикл 
		...
		Иначе
			...
			Если Выборка.ВыполнятьЧерезРегламентноеЗадание И НЕ ЗначениеЗаполнено(Задание) Тогда		
