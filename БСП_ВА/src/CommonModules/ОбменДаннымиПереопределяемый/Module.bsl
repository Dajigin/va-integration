		...
		Если ТипЗнч(Получатель) = Тип("ПланОбменаСсылка._ДемоОбменСБиблиотекойСтандартныхПодсистем")
			...
			Если МассивРежимовКОбработке.Найти(РежимыВыгрузки.РежимВыгрузкиСправочников) <> Неопределено
				...
				Для Каждого ЭлементСоставаПланаОбмена Из СоставПланаОбмена Цикл 
					...
					ИначеЕсли ОбщегоНазначения.ЭтоДокумент(ЭлементСоставаПланаОбмена.Метаданные)
						Или ОбщегоНазначения.ЭтоЗадача(ЭлементСоставаПланаОбмена.Метаданные)
						Или ОбщегоНазначения.ЭтоБизнесПроцесс(ЭлементСоставаПланаОбмена.Метаданные) Тогда
