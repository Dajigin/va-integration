...
Процедура УстановкаПараметровСеанса(ИмяПараметра, УстановленныеПараметры) Экспорт
	Если ИмяПараметра = "ЛогироватьОбъектыАвтоТестирования" Тогда
		...
		Если ЛогироватьПоПараметруЗапуска Тогда
			ПараметрыСеанса.ЛогироватьОбъектыАвтоТестирования =  Истина;
		Иначе
			ПараметрыСеанса.ЛогироватьОбъектыАвтоТестирования =  Ложь;
		КонецЕсли;
		УстановленныеПараметры.Добавить("ЛогироватьОбъектыАвтоТестирования");	
	КонецЕсли;
	
	Если ИмяПараметра = "АвтоТестыВыполняются" Тогда
		Попытка
//			Если значение не задано - вызывается исключение. 
			ЗначениеЗаполнено(ПараметрыСеанса.АвтоТестыВыполняются);
		Исключение	 
			ПараметрыСеанса.АвтоТестыВыполняются = Ложь;			
		КонецПопытки;
