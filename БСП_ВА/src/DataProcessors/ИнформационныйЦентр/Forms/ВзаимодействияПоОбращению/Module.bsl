...
Процедура ЗаполнитьПереписку(ДанныеПоПереписке)
	...
	Для Каждого ЭлементВзаимодействия Из ДанныеПоПереписке.Interactions Цикл 
		...
		НовоеВзаимодействие.Описание = ?(ПустаяСтрока(ЭлементВзаимодействия.Description), НСтр("ru = '<Без текста>'"), ЭлементВзаимодействия.Description);
		...
		НовоеВзаимодействие.ПояснениеККартинке = ?(ЭлементВзаимодействия.Incoming, НСтр("ru = 'Вх.'"), НСтр("ru = 'Исх.'"));
