...
Сценарий: Документ Оприходование товаров
	Дано я подключаю TestClient "Этот клиент" логин "" пароль ""
	И я закрыл все окна клиентского приложения
	И я читаю данные текущего профиля клиента тестирования
	И если переменная "ИмяКлиентаТестирования" имеет значение "Пользователь"
