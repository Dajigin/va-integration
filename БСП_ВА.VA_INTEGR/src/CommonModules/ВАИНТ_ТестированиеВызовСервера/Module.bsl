...
Функция ПараметрыПодсистемыАвтоТестирования() Экспорт
	...
	ЕстьПодсистемаТестирования = ВАИНТ_ТестированиеВызовСервераПовтИсп.ЕстьПодсистемаАвтоТестирование();
	Результат.ЕстьПодсистемаАвтоТестирования = ЕстьПодсистемаТестирования;
