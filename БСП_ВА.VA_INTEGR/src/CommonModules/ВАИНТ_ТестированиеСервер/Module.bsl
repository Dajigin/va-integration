...
Процедура УдалитьОбъектыСозданныеПриТестировании() Экспорт
	...
	КонецЕсли;
	ОбъектыИмеющиеДату = АвтоТестированиеСервер.ОбъектыСозданныеПриТестированииИмеющиеДату();
	Пока ОбъектыИмеющиеДату.Следующий() Цикл
		ОписаниеОбъекта = ОписаниеОбъектаПоИмениМетаданных(ОбъектыИмеющиеДату.ИмяТипа);
		ТипМетаданных = ОписаниеОбъекта.ТипМетаданных;
		ИдентификаторОбъекта = Новый УникальныйИдентификатор(ОбъектыИмеющиеДату.УникальныйИдентификатор);
		...
		КонецЕсли;
		НомерЗаписи = ОбъектыИмеющиеДату.НомерЗаписи;
		АвтоТестированиеСервер.УдалитьРегистрациюОбъектаТестированияИмеющегоДату(НомерЗаписи, ИдентификаторОбъекта);
	КонецЦикла;	
КонецПроцедуры
#КонецОбласти
