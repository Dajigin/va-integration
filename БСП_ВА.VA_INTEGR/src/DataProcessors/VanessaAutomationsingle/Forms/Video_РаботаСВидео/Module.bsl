...
Процедура ОбработатьТегиУправляющиеГолосом(МассивТеговШага, ПараметрыГолоса)
	Если МассивТеговШага.Количество() > 0 Тогда
...
Процедура РазобратьПараметрыСтроки(СтрокаПарамеровГолоса, ПараметрыГолоса)
	...
	ПараметрыГолоса.Скорость = ТекСкорость;
...
Процедура ЗавершитьЗаписьВыполненияТестов(ПараметрыВидео) Экспорт
	...
	ИмяФайлаВидеоИсходный = ПараметрыВидео.КаталогДляЗаписиВидеоВыполненияТестов
...
Процедура НачатьЗаписьВыполненияТестов(ПараметрыВидео) Экспорт
	ИмяФайлаВидео = ПараметрыВидео.КаталогДляЗаписиВидеоВыполненияТестов
		+ "\scen" + XMLСтрока(ПараметрыВидео.ТекИД_СценарияВМассиве) + ".mp4";
