...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ДляКаждогоФайлаИзКаталога(Парам01,Парам02)","ДляКаждогоФайлаИзКаталога",
		"И для каждого файла ""ТекФайл"" из каталога ""ИмяКаталога""",
		"Цикл. Делает перебор файлов в каталоге, исключая подкаталоги. Также создаёт переменные:  _Имя, _ПолноеИмя, _ИмяБезРасширения, _Путь, _Расширение.",
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ДляКаждогоФайлаИзКаталогаВключаяПодкаталоги(Парам01,Парам02)","ДляКаждогоФайлаИзКаталогаВключаяПодкаталоги",
		"И для каждого файла ""ТекФайл"" из каталога ""ИмяКаталога"" включая подкаталоги",
		"Цикл. Делает перебор файлов в каталоге, включая подкаталоги. Также создаёт переменные:  _Имя, _ПолноеИмя, _ИмяБезРасширения, _Путь, _Расширение.",
		"Файлы.Перебор файлов",
		"Цикл");
