...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты, "ВидеовставкаКартинки(Парам01,Парам02)", "ВидеовставкаКартинки","И видеовставка картинки ""ИмяКартинки"" ""ТекстДиктора""","Добавляет в видео вставку из указанной картинки с указанным текстом диктора.", "Прочее.Автоинструкции");
