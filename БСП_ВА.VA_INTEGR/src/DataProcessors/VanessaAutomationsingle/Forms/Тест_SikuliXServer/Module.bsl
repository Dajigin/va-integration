...
&НаКлиенте
Процедура НайтиКартинкуНаЭкране(ПутьКФайлу, ИмяФайла, Действие, ДопПараметры = Неопределено)
...
&НаКлиенте
Процедура ОкончаниеВызоваНайтиНаЭкране(Результат, ПараметрыВызова, ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ОкончаниеВызоваЭмуляцияДвиженияМыши(Результат, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	ОписаниеОповещения = Новый ОписаниеОповещения("ОкончаниеВызоваВнешнейКомпоненты", ЭтаФорма, ДополнительныеПараметры);
...
&НаКлиенте
Процедура ОкончаниеВызоваВнешнейКомпоненты(Результат, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	Ванесса.ПродолжитьВыполнениеШагов();
КонецПроцедуры
...
&НаКлиенте
Процедура ДополнитьСтруктуруДанныхКоординатКартинки(Данные)
...
Процедура ЯРисуюСтрелкуОтТекстаДоТекста(ТекстОт, ТекстДо, ТабПарам) Экспорт
	ИмяФайлСтрелки = Ванесса.Объект.КаталогИнструментов + "/tools/VideoTools/Arrow.exe";
	Если НЕ Ванесса.ФайлСуществуетКомандаСистемы(ИмяФайлСтрелки) Тогда
		ТекстСообщения = Ванесса.ПолучитьТекстСообщенияПользователю("Не найден файл <%1>");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%1", ИмяФайлСтрелки);
...
&НаКлиенте
Процедура ОбработчикЯЖдуКартинкиВТечениеСекунд()
...
&НаКлиенте
Процедура ОкончаниеВызоваНайтиНаЭкранеОбработчикЯЖдуКартинкиВТечениеСекунд(Результат, ПараметрыВызова, ДополнительныеПараметры) Экспорт
...
Процедура ЯЖдуКартинкиВТечениеСекунд(ИмяКартинки, КоличествоСекунд) Экспорт
	...
	ПараметрыСкрипта = Новый Массив;
	ПараметрыСкрипта.Добавить(ПутьКФайлу);
	ПараметрыСкрипта.Добавить(XMLСтрока(КоличествоСекунд));
...
&НаКлиенте
Процедура ЯПоказываюПодсказкуEnjoyHintУКартинкиНаЭкране(ТекстПодсказки, ИмяКартинки, ТабПарам) Экспорт
...
&НаКлиенте
Процедура ЯПоказываюНаЭкранеТекст(ТекстПодсказки, ТабПарам) Экспорт
...
&НаКлиенте
Процедура ОкончаниеНачатьВызовПоказатьТекст(Результат, ПараметрыВызова, ДополнительныеПараметры) Экспорт
