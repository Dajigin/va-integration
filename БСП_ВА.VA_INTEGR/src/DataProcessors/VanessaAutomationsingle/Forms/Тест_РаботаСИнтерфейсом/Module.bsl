...
Процедура ВПанелиОткрытыхЯВыбираю(ИмяКнопки) Экспорт
	...
	КнопкаКомандногоИнтерфейса = ПанельОткрытых.НайтиОбъект(Тип("ТестируемаяКнопкаКомандногоИнтерфейса"), ИмяКнопки,,10);
	Если КнопкаКомандногоИнтерфейса = Неопределено Тогда
...
Процедура ЯБудуВыбиратьВнешнийФайл(Знач ИмяФайла,
