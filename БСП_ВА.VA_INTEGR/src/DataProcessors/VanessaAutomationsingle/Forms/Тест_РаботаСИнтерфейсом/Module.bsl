...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТабличномДокументеЯПерехожуКЯчейке(Парам01,Парам02)","ВТабличномДокументеЯПерехожуКЯчейке","И в табличном документе ""РеквизитТабличныйДокумент"" я перехожу к ячейке ""АдресЯчейки""","Делает нужную ячейку табличного документа активной","UI.Табличный документ.Ячейки");
...
Процедура ОбработичкОжиданияЯЖдуЧтоТаблицаСтанетРавнаДаннойВТеченииСекунд()
	ИмяОбработчика = "ОбработичкОжиданияЯЖдуЧтоТаблицаСтанетРавнаДаннойВТеченииСекунд";
...
Процедура ОбработичкОжиданияЯЖдуЧтоТаблицаСтанетСодержатьСтрокиВТечениеСекунд()
	ИмяОбработчика = "ОбработичкОжиданияЯЖдуЧтоТаблицаСтанетСодержатьСтрокиВТечениеСекунд";
...
&НаКлиенте
Процедура СравнитьТабличныйДокументСЭталоном(ТабПарамБыло, ТабДокСтало, ЧтениеИзТабличногоДокумента, ПоШаблону)
...
Процедура ТабличныйДокументФормыСИменемСодержитСтроки(ИмяРеквизита, ТабПарамБыло, ПоШаблону = Ложь) Экспорт
	Нашли = Ложь;
	...
	БылаОшибка = Ложь;
	Попытка
		СравнитьТабличныйДокументСЭталоном(ТабПарамБыло, ТабДокСтало, ЧтениеИзТабличногоДокумента, ПоШаблону);
	Исключение
...
Функция ТабличныйДокументСодержитСтрокиИзМакета(ИмяРеквизита, ИмяМакета, ПоШаблону = Ложь) Экспорт
	ТабДокБыло = ПолучитьМакетИзОбработкиИлиИзКаталогаПроекта(ИмяМакета);
	ТабличныйДокументФормыСИменемСодержитСтроки(ИмяРеквизита, ТабДокБыло, ПоШаблону);
КонецФункции
...
Процедура ЯНажимаюНаКнопкуСоздатьПоля(ИмяРеквизита,ИскатьПоИмени = Ложь) Экспорт
	...
	Для СчетчикПопыток = 1 По КоличествоПопыток Цикл
		...
		Попытка
			...
			Попытка
				Ванесса.ОткрытьВыпадающийСписокБраузер(ПолеРеквизит);
...
Процедура ОбработичкОжиданияЯЖдуЧтоВТаблицеКоличествоСтрокБудетВТеченииСекунд()
	ИмяОбработчика = "ОбработичкОжиданияЯЖдуЧтоВТаблицеКоличествоСтрокБудетВТеченииСекунд";
...
Процедура ОбработичкОжиданияЯЖдуЧтоВОкнеВТаблицеКоличествоСтрокБудетВТеченииСекунд()
	ИмяОбработчика = "ОбработичкОжиданияЯЖдуЧтоВОкнеВТаблицеКоличествоСтрокБудетВТеченииСекунд";
...
Процедура ОбработичкОжиданияЯЖдуЧтоПолеПерестанетБытьПустымВТеченииСекунд()
	ИмяОбработчика = "ОбработичкОжиданияЯЖдуЧтоПолеПерестанетБытьПустымВТеченииСекунд";
...
Процедура ОбработичкОжиданияЯЖдуЧтоУГруппыСтраницТекущейСтраницейСтанетВТеченииСекунд()
	ИмяОбработчика = "ОбработичкОжиданияЯЖдуЧтоУГруппыСтраницТекущейСтраницейСтанетВТеченииСекунд";
...
Процедура ОбработичкОжиданияВТаблицеУПоляЯЖдуЗначенияВТечениеСекунд()
	ИмяОбработчика = "ОбработичкОжиданияВТаблицеУПоляЯЖдуЗначенияВТечениеСекунд";
...
Процедура ОбработичкОжиданияЯЖдуЧтоВТаблицеТекущееПолеБудетЗаполненоВТечениеСекунд()
	ИмяОбработчика = "ОбработичкОжиданияЯЖдуЧтоВТаблицеТекущееПолеБудетЗаполненоВТечениеСекунд";
...
Процедура ОбработичкОжиданияЯЖдуЧтоВТабличномДокументеЯчейкаСтанетРавнаВТечениеСекунд()
	ИмяОбработчика = "ОбработичкОжиданияЯЖдуЧтоВТабличномДокументеЯчейкаСтанетРавнаВТечениеСекунд";
