...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюВыпадающийСписок(Парам01)","ЯОткрываюВыпадающийСписок","И я открываю выпадающий список ""Заголовок элемента""","Открывает выпадающий список","UI.Выпадающий список.Открыть список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюВыпадающийСписокСИменем(Парам01)","ЯОткрываюВыпадающийСписокСИменем","И я открываю выпадающий список с именем ""ИмяЭлемента""","Открывает выпадающий список","UI.Выпадающий список.Открыть список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОтменяюФиксированиеГруппы()","ЯОтменяюФиксированиеГруппы","И я отменяю фиксирование группы","Снимает фиксирование группы.","UI.Группы.Зафиксировать группу");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗакрываюВыпадающийСписок(Парам01)","ЯЗакрываюВыпадающийСписок","И я закрываю выпадающий список ""ИмяПоля""","Закрывает выпадающий список","UI.Выпадающий список.Закрыть список");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗакрываюВыпадающийСписокСИменем(Парам01)","ЯЗакрываюВыпадающийСписокСИменем","И я закрываю выпадающий список с именем ""ИмяПоля""","Закрывает выпадающий список","UI.Выпадающий список.Закрыть список");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯЗакрываюВыпадающийСписок(Парам01,Парам02)","ВТаблицеЯЗакрываюВыпадающийСписок","И в таблице ""ИмяТаблицы"" я закрываю выпадающий список ""ИмяПоля""","Закрывает выпадающий список","UI.Выпадающий список.Закрыть список");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВТаблицеЯЗакрываюВыпадающийСписокСИменем(Парам01,Парам02)","ВТаблицеЯЗакрываюВыпадающийСписокСИменем","И в таблице ""ИмяТаблицы"" я закрываю выпадающий список с именем ""ИмяПоля""","Закрывает выпадающий список","UI.Выпадающий список.Закрыть список");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"HTMLДокументСталРавен(Парам01, Парам02)","HTMLДокументСталРавен","Тогда HTML документ ""Заголовок элемента"" стал равен","Проверяет содержимое HTML документа. Реквизит исчется по заголовку.","UI.Поле HTML документа.Проверка значения");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"HTMLДокументСИменемСталРавен(Парам01, Парам02)","HTMLДокументСИменемСталРавен","Тогда HTML документ с именем ""ИмяЭлемента"" стал равен","Проверяет содержимое HTML документа. Реквизит исчется по имени.","UI.Поле HTML документа.Проверка значения");
...
&НаКлиенте
Процедура ОбработчикОжиданияВОткрытойФормеЯЖдуПоявленияЭлементаВТеченииСекунд()
	...
	Если ТекущаяВидимость = Истина Тогда
		ОтключитьОбработчикОжидания(ИмяОбработчика);
...
&НаКлиенте
Процедура ОбработчикОжиданияВОткрытойФормеЯЖдуДоступностиЭлементаВТечениеСекунд()
...
Процедура ЯЖдуНедоступностиЭлементаВТечениеСекунд(ИмяЭлемента, КоличествоСекунд, ИскатьПоИмени = Ложь) Экспорт
	Ванесса.ЗапретитьВыполнениеШагов();
	ДатаНачалаОбработкиОжидания       = ТекущаяДата();
	ИмяПоляОбработкаОжидания          = ИмяЭлемента;
	ИскатьПоИмениОбрабткаОжидания     = ИскатьПоИмени;
...
//@ЯЖдуДоступностиЭлементаСИменемВТечениеСекунд(Парам01, Парам02)
Процедура ЯЖдуНедоступностиЭлементаСИменемВТечениеСекунд(ИмяЭлемента, КоличествоСекунд) Экспорт
...
&НаКлиенте
Процедура ОбработчикОжиданияУЭлементаЯЖдуЗначенияВТеченииСекунд()
...
Процедура ЯЗакрываюВсеОкнаКлиентскогоПриложения() Экспорт
...
Процедура ЯЗакрываюВсеОкнаКлиентскогоПриложенияКроме(ЗаголовокОкна) Экспорт
...
Процедура ВТЧЯЗавершаюРедактированиеСтроки(ИмяТЧ, ОтменаРедактирования = Ложь) Экспорт
	ТЧ = Ванесса.НайтиТЧПоИмени(ИмяТЧ);
	Если ТЧ.ТекущийРежимРедактирование() Тогда
...
Процедура ВТаблицеЯОтменяюРедактированиеСтроки(ИмяТЧ) Экспорт
...
Процедура ЭлементФормыСталРавенПоШаблону(ИмяЭлемента,СтроковоеПредставление,ИскатьПоИмени = Ложь) Экспорт
...
Процедура ЭлементФормыСИменемСталРавенПоШаблону(ИмяЭлемента,СтроковоеПредставление) Экспорт
	ЭлементФормыСталРавенШаблону(ИмяЭлемента, СтроковоеПредставление, Истина);
КонецПроцедуры
...
&НаКлиенте
Процедура ОбработчикОжиданияЯЖдуЧтоТаблицаСтанетРавнаДаннойВТеченииСекунд()
...
&НаКлиенте
Процедура ОбработчикОжиданияЯЖдуЧтоТаблицаСтанетСодержатьСтрокиВТечениеСекунд()
...
Процедура ВПанелиРазделовЯВыбираю(ИмяКнопки, ДопПараметры = Неопределено) Экспорт
	ТекстОшибки = "";
	Ошибка = Ложь;
	КоличествоПопыток = Ванесса.ЗначениеКоличествоПопытокВыполненияДействия();
	Если ТипЗнч(ДопПараметры) = Тип("Структура") Тогда
...
Процедура ВПанелиФункцийЯВыбираю(ИмяКнопки, ДопПараметры = Неопределено) Экспорт
	ТекстОшибки = "";
	Ошибка = Ложь;
	КоличествоПопыток = Ванесса.ЗначениеКоличествоПопытокВыполненияДействия();
...
&НаКлиенте
Процедура СравнитьТабличныйДокументСЭталоном(ТабПарамБыло, ТабДокСтало, ЧтениеИзТабличногоДокумента, ПоШаблону, ДопПараметры = Неопределено)
...
Процедура ТабличныйДокументФормыСИменемСодержитСтроки(ИмяРеквизита, ТабПарамБыло, ПоШаблону = Ложь, ТолькоСтрокиИзЭталона = Ложь) Экспорт
	Нашли = Ложь;
...
Процедура ТабличныйДокументСодержитСтроки(ИмяРеквизита, ТабПарамБыло) Экспорт
...
Процедура ТабличныйДокументСодержитСтрокиПоШаблону(ИмяРеквизита, ТабПарамБыло) Экспорт
...
Процедура ЯВыбираюФайлСИндексомФильтра(
	Знач ИндексФильтра,
	Знач ИмяФайла,
	ЧастьИмени2 = Неопределено,
	ЧастьИмени3 = Неопределено,
...
Процедура ВПолеЯВвожуЗначениеВыражения(ИмяРеквизита, Знач ПараметрТекст, ИскатьПоИмени = Ложь) Экспорт
	ПолучилосьВычислить = Ложь;
	Попытка
		Текст = XMLСтрока(Ванесса.ВычислитьВнутреннееВыражение(ПараметрТекст));
...
Процедура ВТаблицеВПолеЯВвожуЗначениеВыражения(ИмяТаблицы, ИмяРеквизита, Знач ПараметрТекст, ИскатьПоИмени = Ложь) Экспорт
	ПолучилосьВычислить = Ложь;
	Попытка
		Текст = XMLСтрока(Ванесса.ВычислитьВнутреннееВыражение(ПараметрТекст));
		ПолучилосьВычислить = Истина;
...
Процедура ПоявилосьПредупреждениеСодержащееТекст(Текст = Неопределено,ЭтоУсловие = Ложь, ПоШаблону = Ложь) Экспорт
...
Процедура ПоявилосьПредупреждениеСодержащееТекстПоШаблону(Текст = Неопределено) Экспорт
...
Процедура ПоявилосьПредупреждениеВТечениеСекундТогда(КолСекунд) Экспорт
...
&НаКлиенте
Процедура ПоявилосьПредупреждениеВТечениеСекундТогдаОбработчик()
...
Процедура ВПолеСИменемЯВвожуЗначениеПеременной(Парам01,ИмяПеременной) Экспорт
...
Процедура ПолеСуществуетТогда(ИмяПоля,ИскатьПоИмени = Ложь) Экспорт
...
Процедура ПолеСИменемСуществуетТогда(ИмяПоля) Экспорт
...
Процедура УПоляЯПерехожуКДате(ИмяРеквизита,Знач Дат,ИскатьПоИмени = Ложь) Экспорт
	ПолеРеквизит = Ванесса.НайтиРеквизитОткрытойФормыПоЗаголовку(ИмяРеквизита,ИскатьПоИмени, Истина, Тип("ТестируемоеПолеФормы"));
	ПолеРеквизит.Активизировать();
...
Процедура ВТабличномДокументеЯчейкаСАдресомРавна(ИмяРеквизита,Знач АдресЯчейки,Знач Значение, ПоШаблону = Ложь) Экспорт
	БылаОшибка = Ложь;
	ТекстСообщения = "";
...
Процедура ВТабличномДокументеЯчейкаСАдресомРавнаПоШаблону(ИмяРеквизита,Знач АдресЯчейки,Знач Значение) Экспорт
...
&НаКлиенте
Процедура ОбработчикОжиданияЯЖдуЧтоВТаблицеКоличествоСтрокБудетВТеченииСекунд()
...
&НаКлиенте
Процедура ОбработчикОжиданияЯЖдуЧтоВОкнеВТаблицеКоличествоСтрокБудетВТеченииСекунд()
...
Процедура ТабличныйДокументСодержитЗначения(ИмяЭлементаФормыИлиФайла,ТабПарам,ЗначенияВходят = Истина) Экспорт
...
Процедура ВПолеЯВвожуТекстИзМакета(ИмяПоля,ИмяМакета, ИскатьПоИмени = Ложь) Экспорт
	Макет = ПолучитьМакетИзОбработкиИлиИзКаталогаПроекта(ИмяМакета);
...
Процедура ВПолеСИменемЯВвожуТекстИзМакета(ИмяПоля,ИмяМакета) Экспорт
...
&НаКлиенте
Процедура ОбработчикОжиданияЯЖдуЧтоПолеПерестанетБытьПустымВТеченииСекунд()
...
Процедура ЗначениеПоляСИменемРавноЗначениюИзМакета(ИмяПоля,ИмяМакета) Экспорт
...
&НаКлиенте
Процедура ОбработчикОжиданияЯЖдуЧтоУГруппыСтраницТекущейСтраницейСтанетВТеченииСекунд()
...
Процедура ЯФиксируюГруппу(ИмяГруппы, ИскатьПоИмени = Ложь) Экспорт
	АктивноеОкно = Ванесса.ПолучитьАктивноеОкноИзТестовоеПриложение();
...
Процедура ЯФиксируюГруппуСИменем(ИмяГруппы) Экспорт
...
Процедура ЯОтменяюФиксированиеГруппы() Экспорт
	Ванесса.ЗафиксироватьФормуГруппуTestClient(Неопределено);
КонецПроцедуры
...
Процедура ЯЗапоминаюПредставлениеТекущегоПоляКак(ИмяПеременной) Экспорт
    АктивноеОкно = Ванесса.ПолучитьАктивноеОкноИзТестовоеПриложение();
    АктивнаяФорма = АктивноеОкно.НайтиОбъект(Тип("ТестируемаяФорма"));
...
Процедура ЯЗапоминаюИмяТекущегоПоляКак(ИмяПеременной, ЗапоминатьИмя = Истина) Экспорт
    АктивноеОкно = Ванесса.ПолучитьАктивноеОкноИзТестовоеПриложение();
    АктивнаяФорма = АктивноеОкно.НайтиОбъект(Тип("ТестируемаяФорма"));
...
Процедура ЯЗапоминаюЗаголовокТекущегоПоляКак(ИмяПеременной, ЗапоминатьИмя = Истина) Экспорт
...
Процедура ЯЗапоминаюИмяТекущейТаблицыКак(ИмяПеременной) Экспорт
    АктивноеОкно = Ванесса.ПолучитьАктивноеОкноИзТестовоеПриложение();
    АктивнаяФорма = АктивноеОкно.НайтиОбъект(Тип("ТестируемаяФорма"));
...
&НаКлиенте
Процедура ОбработчикОжиданияВТаблицеУПоляЯЖдуЗначенияВТечениеСекунд()
...
&НаКлиенте
Процедура ОбработчикОжиданияЯЖдуЧтоВТаблицеТекущееПолеБудетЗаполненоВТечениеСекунд()
...
Процедура ВыпадающийСписокСталРавен(ИмяЭлемента,ТабПарам,ИскатьПоИмени = Ложь, ЭтоУсловие=Ложь) Экспорт
...
Процедура ВыпадающийСписокСталРавенТогда(ИмяЭлемента,ТабПарам) Экспорт
...
//@ВыпадающийСписокСИменемСодержитЗначения(Парам01,ТабПарам)
Процедура ВыпадающийСписокСИменемСталРавенТогда(ИмяЭлемента,ТабПарам) Экспорт
...
Процедура ВыпадающийСписокСодержитЗначения(ИмяЭлемента,ТабПарам,ИскатьПоИмени = Ложь, ЭтоУсловие=Ложь) Экспорт
	БылаОшибка = Ложь;
	ТекстСообщения = "";
...
//Если выпадающий список "Реквизит1" содержит значения Тогда
//@ВыпадающийСписокСИменемСодержитЗначения(Парам01,ТабПарам)
Процедура ВыпадающийСписокСодержитЗначенияТогда(ИмяЭлемента,ТабПарам) Экспорт
...
//Если выпадающий список с именем "Реквизит1" содержит значения Тогда
//@ВыпадающийСписокСИменемСодержитЗначения(Парам01,ТабПарам)
Процедура ВыпадающийСписокСИменемСодержитЗначенияТогда(ИмяЭлемента,ТабПарам) Экспорт
...
&НаКлиенте
Процедура ОбработчикОжиданияЯЖдуЧтоВТабличномДокументеЯчейкаСтанетРавнаВТечениеСекунд()
...
&НаКлиенте
Процедура УстановитьЗначениеВПолеПриЗаполненииТаблицы(Таблица,РеквизитТаблицы,Текст,ИмяТаблицы,ВводитьТекст)
	...
	Для Ккк = 1 По ТабПарам.Количество()-1 Цикл
		...
		Для Каждого СтрокаКолонки Из МассивКолонки Цикл
			...
			Пока Истина Цикл
				...
				ТекстСледущегоПоля = СтрокаТабПарам[XMLСтрока("Кол" + СледущаяКолонка)];
...
Процедура ЯЗапоминаюИмяКонфигурацииКак(ИмяПеременной) Экспорт
	Ванесса.ОбработатьСменуАктивногоОкна();
...
&НаКлиенте
Процедура ОбработчикУПоляЯЖдуЗначенияОтличногоОтВТечениеСекунд()
...
&НаКлиенте
Процедура ОбработчикОжиданияЯЖдуЗакрытияФормыВТечениеСекунд()
...
&НаКлиенте
Процедура ОбработчикОжиданияЯЖдуОткрытияФормыВТечениеСекунд()
