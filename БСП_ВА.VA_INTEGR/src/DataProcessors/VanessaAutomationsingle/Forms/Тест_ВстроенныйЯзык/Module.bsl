...
Процедура ВыражениеВнутреннегоЯзыкаСталоИстинноВТечениеСекунд(Знач ПараметрВыражение, КолСекунд) Экспорт
...
&НаКлиенте
Процедура ВыражениеВнутреннегоЯзыкаСталоИстинноВТечениеСекундОбработчик()
