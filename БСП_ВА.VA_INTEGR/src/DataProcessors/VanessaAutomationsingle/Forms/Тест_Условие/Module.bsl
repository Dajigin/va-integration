...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыСталРавенВТечениеСекундТогда(Парам01,Парам02,Парам03)","ЭлементФормыСталРавенВТечениеСекундТогда","Если элемент формы ""Заголовок поля"" стал равен ""ЗначениеПоля"" в течение 10 секунд Тогда","Условие. Проверяет значение элемента формы в течение нужного числа секунд.","UI.Формы.Поля.Проверка значения поля","Условие");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыСИменемСталРавенВТечениеСекундТогда(Парам01,Парам02,Парам03)","ЭлементФормыСИменемСталРавенВТечениеСекундТогда","Если элемент формы с именем ""ИмяПоля"" стал равен ""ЗначениеПоля"" в течение 10 секунд Тогда","Условие. Проверяет значение элемента формы в течение нужного числа секунд. Поиск элемента формы производится по имени.","UI.Формы.Поля.Проверка значения поля","Условие");
...
//Если "Истина" тогда
//@Тогда(Парам01)
Процедура Условие(Знач Выражение,
...
Процедура ЯВызываюИсключение(Знач Текст) Экспорт
...
Процедура ЭлементФормыИмеетЗначениеТогда(ИмяЭлемента,НужноеЗначение,ИскатьПоИмени = Ложь) Экспорт
...
Процедура ЭлементФормыСИменемИмеетЗначениеТогда(ИмяЭлемента,НужноеЗначение) Экспорт
	ПолеИмеетЗначениеТогда(ИмяЭлемента,НужноеЗначение,Истина);
КонецПроцедуры
...
Процедура ЭлементФормыИмеетЗначениеПоШаблонуТогда(ИмяЭлемента,НужноеЗначение,ИскатьПоИмени = Ложь) Экспорт
...
Процедура ЭлементФормыСИменемИмеетЗначениеПоШаблонуТогда(ИмяЭлемента,НужноеЗначение) Экспорт
	ПолеИмеетЗначениеПоШаблонуТогда(ИмяЭлемента,НужноеЗначение,Истина);
КонецПроцедуры
...
Процедура ЭлементПрисутствуетНаФормеТогда(ИмяПоля, ИскатьПоИмени = Истина) Экспорт
	ДопПараметры = Новый Структура;
	ДопПараметры.Вставить("ТекущаяФормаЭлемента",Неопределено);
...
Процедура ЭлементСЗаголовкомПрисутствуетНаФормеТогда(ИмяПоля) Экспорт
...
Процедура СуществуетПеременнаяТогда(ИмяПеременной, ПроверятьСуществование = Истина) Экспорт
	Результат = Ложь;
...
Процедура НеСуществуетПеременнаяТогда(ИмяПеременной) Экспорт
...
Процедура ЭлементФормыСталРавенВТечениеСекундТогда(ИмяПоля,Значение,КоличествоСекунд) Экспорт
...
Процедура ЭлементФормыСИменемСталРавенВТечениеСекундТогда(ИмяПоля,ЗначениеПоля,КоличествоСекунд) Экспорт
	ПолеСталоРавноВТечениеСекундТогда(ИмяПоля, ЗначениеПоля, КоличествоСекунд, Истина);
КонецПроцедуры
