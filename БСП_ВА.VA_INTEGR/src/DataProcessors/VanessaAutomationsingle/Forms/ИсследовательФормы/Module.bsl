...
Процедура ЗаполнитьТекстШаговПоАктивномуЭлементу()
	...
	Если ТипЗнч(ЭлементФормы) = Тип("ТестируемоеПолеФормы") Тогда
		...
		Если ТаблицаВладелец <> Неопределено Тогда
			...
			МассивШагов.Добавить("");
			МассивШагов.Добавить("И я запоминаю значение таблицы """ + ТаблицаВладелец.Имя + """ поля с именем """ + ЭлементФормы.Имя + """ как """ + ЭлементФормы.Имя + """");
		...
		Иначе
			МассивШагов.Добавить("");
			МассивШагов.Добавить("И у элемента с именем """ + ЭлементФормы.Имя + """ я жду значения """ + ЗначениеПоля + """ в течение 60 секунд");
			МассивШагов.Добавить("");
			МассивШагов.Добавить("И я запоминаю значение поля с именем """ + ЭлементФормы.Имя + """ как """ + ЭлементФормы.Имя + """");
			МассивШагов.Добавить("И в поле с именем """ + ЭлементФормы.Имя + """ я ввожу текст '" + ЗначениеПоля + "'");
	...
	ИначеЕсли ТипЗнч(ЭлементФормы) = Тип("ТестируемаяГруппаФормы") Тогда	
		МассивШагов.Добавить("И я жду появления элемента """ + ЭлементФормы.ТекстЗаголовка + """ в течение 20 секунд");
