...
Процедура ВТабличномДокументеИМакетеОдинаковыеИзображения(ИмяРеквизита, ИмяМакета, СравнениеПоШаблону = Ложь) Экспорт
...
&НаКлиенте
Процедура ПроверитьКартинкиВМакетах(Таб1, Таб2)
