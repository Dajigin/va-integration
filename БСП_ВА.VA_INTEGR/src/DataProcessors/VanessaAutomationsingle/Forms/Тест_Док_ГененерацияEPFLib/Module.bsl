...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	ДобавитьШагВМассивТестов(ВсеТесты,"ВКонфигуратореЯОткрываюОсновнуюФормуОбработки()","ВКонфигуратореЯОткрываюОсновнуюФормуОбработки","И в конфигураторе я открываю основную форму обработки");
