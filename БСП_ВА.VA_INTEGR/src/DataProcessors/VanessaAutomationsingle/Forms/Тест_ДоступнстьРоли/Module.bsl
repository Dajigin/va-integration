...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"МнеДоступнаРоль(Парам01)","МнеДоступнаРоль","Мне доступна роль ""Админ""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"МнеНеДоступнаРоль(Парам01)","МнеНеДоступнаРоль","Мне не доступна роль ""НедоступнаяРоль""");
