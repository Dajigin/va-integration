...
Процедура ЯВывожуТаблицуGherkinВОкноСообщенийПользователя(ТабПарам) Экспорт
...
Процедура СлужебноеУсловиеВКотороеПередаётсяТаблицаВыполненоТогда(ТабПарам) Экспорт
