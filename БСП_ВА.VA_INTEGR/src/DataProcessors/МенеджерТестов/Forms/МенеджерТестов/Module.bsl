...
КонецПроцедуры
&НаКлиенте
Процедура ОбновитьДеревоНаборовТестов()
	...
	ОбновитьДеревоНаборовТестовНаСервере(СтруктураНаборов);
КонецПроцедуры
&НаСервере
Процедура ОбновитьДеревоНаборовТестовНаСервере(СтруктураФайлов)
	Дерево = РеквизитФормыВЗначение("ДеревоНаборыТестов");
	Дерево.Строки.Очистить();
	ВАИНТ_ТестированиеСервер.СоответствиеВДеревоЗначений(СтруктураФайлов, Дерево);
